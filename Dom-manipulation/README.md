...
- Use o comando: `git clone git@github.com:tryber/sd-036-exercise-dom-manipulation.git`
- Entre na pasta do repositório que você acabou de clonar:
  - `cd sd-036-exercise-dom-manipulation`
...
- Vá até a página de *Pull Requests* do [repositório no GitHub](https://github.com/tryber/sd-036-exercise-dom-manipulation/pulls)
...
- Volte até a [página de *Pull Requests* do repositório](https://github.com/tryber/sd-036-exercise-dom-manipulation/pulls) e confira que o seu *Pull Request* está criado
