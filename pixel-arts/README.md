...
* Data para entrega do projeto: `04/09/2023 23:59`.
...
* Use o comando: `git clone git@github.com:tryber/sd-036-project-pixels-art.git`
* Entre na pasta do repositório que você acabou de clonar:
  * `cd sd-036-project-pixels-art`
...
* Vá até a página de _Pull Requests_ do [repositório no GitHub](https://github.com/tryber/sd-036-project-pixels-art/pulls)
...
* Volte até a [página de _Pull Requests_ do repositório](https://github.com/tryber/sd-036-project-pixels-art/pulls) e confira que o seu _Pull Request_ está criado
...
Link: [Formulário de avaliação do projeto](https://be-trybe.typeform.com/to/ZTeR4IbH#cohort_hidden=CH36&template=betrybe/sd-0x-project-pixels-art)
